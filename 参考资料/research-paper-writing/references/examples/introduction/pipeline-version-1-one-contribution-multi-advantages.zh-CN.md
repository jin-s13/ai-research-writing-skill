...
% Advantage 2
%% Example: Another advantage of the proposed method is that the deformable mesh provides a geometric prior (rough surface location) to enable more efficient learning of implicit fields.
